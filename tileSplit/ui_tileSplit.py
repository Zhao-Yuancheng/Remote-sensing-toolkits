...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.browseOpenFileBtn.setText(
        ...
        self.label_3.setText(
            QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58\u683c\u5f0f\uff1a", None))
        self.resultFormatComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u".png",
                                                                            None))
        self.resultFormatComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u".jpg",
                                                                            None))
        self.resultFormatComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u".jpeg",
                                                                            None))
        self.resultFormatComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u".tiff",
                                                                            None))
        self.resultFormatComboBox.setItemText(4, QCoreApplication.translate("MainWindow", u".tif",
                                                                            None))
        self.resultFormatComboBox.setItemText(5, QCoreApplication.translate("MainWindow", u".gif",
                                                                            None))
